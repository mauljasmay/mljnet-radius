        ...
        <div class="hidden lg:block text-white space-y-8">
            <div class="space-y-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-5xl font-bold tracking-tight">MLJNET RADIUS</h1>
        ...
        <div class="w-full max-w-md mx-auto">
            <div class="glass-card rounded-3xl shadow-2xl p-8 lg:p-10">
                ...
                <div class="lg:hidden text-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900">MLJNET RADIUS</h2>
            ...
            <div class="text-center mt-6 text-white text-sm">
                <p>&copy; 2025 MLJNET RADIUS. All rights reserved.</p>
            </div>
        </div>
    </div>
</div>
