        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Edit Template WhatsApp</h1>
                        <p class="text-gray-600 mt-1">Edit template pesan WhatsApp</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <form action="{{ route('admin.whatsapp.templates.update', $template) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type"
                                ...
                                <option value="reminder" {{ old('type', $template->type) == 'reminder' ? 'selected' : '' }}>Pengingat Pembayaran</option>
                                <option value="suspension" {{ old('type', $template->type) == 'suspension' ? 'selected' : '' }}>Penangguhan Layanan</option>
                                <option value="voucher" {{ old('type', $template->type) == 'voucher' ? 'selected' : '' }}>Voucher</option>
                        ...
                        <div>
                            ...
                            @if($template->is_default)
                                <p class="mt-1 text-xs text-yellow-600">
                                    <i class="fas fa-info-circle mr-1"></i>Template ini saat ini adalah default
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="content" rows="8"
                                  ...
                                  placeholder="Ketik isi pesan di sini..." required>{{ old('content', $template->content) }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Preview menggunakan data contoh. Hasil sebenarnya akan bervariasi tergantung data yang digunakan.
                        </p>
                    </div>
